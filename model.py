...
class LSTM_MVP(nn.Module):
    ...
    def init_hidden(self, batch_size):
        ...
        # Julian: removed .cuda() to make work on my Mac
        hidden = (weights.new(self.lstm_num_layers, batch_size, self.lstm_hidden_size).zero_(),
                  weights.new(self.lstm_num_layers, batch_size, self.lstm_hidden_size).zero_())
        return hidden
